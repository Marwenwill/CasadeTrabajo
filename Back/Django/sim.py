...
text = open("50.txt",'r', encoding='utf-8').read()
separator = ",;:?-_/"
...
description = "un ingénieur web qui metrise c++,java , .net html Rdf , javascript , Php , MySql , html ,css et sql est obligatoire. anglais necessaire"
for char in separator :
