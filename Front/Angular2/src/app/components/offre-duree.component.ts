...
@Component({
  selector: 'app-offre-duree',
  templateUrl: './offre-duree.component.html',
  styles: []
})
export class OffreDureeComponent implements OnInit {
  ...
  ngOnInit() {
    this.subscription = this.route.params.subscribe((params: any) => {
      this.toFind = params['duree'];
      this.myService.getOffreByDuree(this.toFind)
      .subscribe(
        data => {
          const myArray = [];
          for (let key in data) {
